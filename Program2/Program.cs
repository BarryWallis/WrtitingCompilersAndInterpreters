...
public class Pascal
{
    ...
    private sealed class ParserMessageListener : IMessageListener
    {
        ...
        public void MessageReceived(Message message)
        {
            if (message is ParserSummaryMessage parserSummaryMessage)
            {
                Console.Write(
                    string.Format(
                        CultureInfo.CurrentCulture,
                        _parserSummaryFormat,
                        parserSummaryMessage.SourceLinesRead,
                        parserSummaryMessage.SyntaxErrors,
                        parserSummaryMessage.ElapsedTime));
            }
        }
    }
